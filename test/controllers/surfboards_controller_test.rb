...
class SurfboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create surfboard" do
    assert_difference('Surfboard.count') do
      post surfboards_url, params: { surfboard: { model: @surfboard.model, shaper: @surfboard.shaper, size: @surfboard.size } }
    end
  ...
  test "should update surfboard" do
    patch surfboard_url(@surfboard), params: { surfboard: { model: @surfboard.model, shaper: @surfboard.shaper, size: @surfboard.size } }
